...
import project_10 from "../assets/image.png"
...
function PortfolioMarquee() {
  ...
  {[ project_10, project_8, project_1, project_2, project_3, project_4, project_5, project_6,project_7, project_9 ].map((img, index) => (
    <div 
