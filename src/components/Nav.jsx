...
function Nav() {
  ...
  const navItems = [
    { icon: <FaHome />, path: '/', tooltip: 'Home' },
    { icon: <FaUser />, path: '/profile', tooltip: 'Profile' },
    { icon: <FaLightbulb />, path: '/skills', tooltip: 'Skills' },
    { icon: <FaGraduationCap />, path: '/education', tooltip: 'Education' },
    { icon: <FaCode />, path: '/projects', tooltip: 'Projects' },
    { icon: <FaEnvelope />, path: '/contact', tooltip: 'Contact' },
    { icon: <FaEllipsisH />, path: '/more', tooltip: 'More' }
  ];
